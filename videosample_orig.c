...
* Linux compile:
* debugging:
* cc -g -o videosample  -I/usr/X11R6/include -I. videosample_orig.c \
     -lGL -lX11 -lGLU -L/usr/X11R6/lib
*
* full optimizations:
* cc -O3 -ffast-math -march=pentiumpro -o videosample  \
      -I/usr/X11R6/include -I. videosample_orig.c  \
      -lGL -lX11 -lGLU -L/usr/X11R6/lib
*
